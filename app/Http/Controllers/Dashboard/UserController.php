        ...
        if ($user) {
            return DataTables::of($user)
                ...
                ->addColumn('status', function (User $user) {
                    return view('components.dashboard.user.index.status', ['status' => $user->status, 'userId' => $user->id]);
                })
                ->addColumn('action', function (User $user) {
                    return view('components.dashboard.user.index.action-btn', ['userId' => $user->id]);
                })
                ->make(true);
        };
    }
