...
<template>
  <v-card>
    ...
    <v-card-text>
      ...
      <TextField class="text-caption text-sm-subtitle-1" placeholder="Nik" hint="NIK (kami menjamin kerahasiaan nik)" />

      <TextField class="text-caption text-sm-subtitle-1" placeholder="Nomor Telepon" hint="Nomor Telepon" />
